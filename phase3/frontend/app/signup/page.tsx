...
const SignupPage = () => {
  ...
  // Clear any potentially invalid token when the signup page loads
  React.useEffect(() => {
    if (typeof window !== 'undefined') {
      // Clear any stored token when on signup page
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response && response.access_token) {
        ...
        console.log('Registration response missing access_token:', response);
      }
    } catch (err: any) {
